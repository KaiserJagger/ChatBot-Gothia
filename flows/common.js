...
const menuOpciones = [ 
    ...
    { keyword: '7', description: '👉 *7:* para conocer nuestros horarios y nuestra ubicación.' },
    { keyword: '8', description: '👉 *8:* para preguntas sobre garantía.' },
    { keyword: '9', description: '👉 *9:* para ver nuestras formas de pago.' },
    { keyword: '10', description: '👉 *10:* para coordinar retiro de equipos a domicilio.' },
];
